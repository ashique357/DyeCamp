   ...
   <div class="card ">
      ...
      <div class="card-body">
         <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
            ...
            <div class="row">
               <div class="col-sm-12">
                  <table class="table tablesorter dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                     <thead>
                        <tr role="row">
                     ...
                     <tbody>
                        <tr role="row" v-for="(user , index) in paginatedData" :key="index">
                           ...
                           <td>
                              <li v-for="(role,index_1) in user.roles" :key="index_1">
                                 {{role.name}}
                              </li>
                           </td>
                           <td>
